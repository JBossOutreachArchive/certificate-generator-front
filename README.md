...
* _**For Certificate Issuers:**_ 
    ...
    2. The Organization dashboard will display the list of all the certificates generated by the Organization.
...
* _**For Candidates:**_
    ...
    3. The candidate will also be allowed to share the certificate(s).
